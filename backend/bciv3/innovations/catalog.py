...
def _make() -> dict:
    ...
    items = [
        Innovation("in_vivo_readout", "In-vivo, non-destructive barcode readout",
                   ...
                   keywords="in vivo neural imaging deep brain non-invasive"),
        Innovation("multiplexed_reporters", "Massively-multiplexed reporters",
                   ...
                   _eval_multiplex, keywords="neuronal barcoding multiplexed connectomics"),
        Innovation("transsynaptic_pairing", "Trans-synaptic pairing at scale + fidelity",
                   ...
                   _eval_pairing, keywords="trans-synaptic tracing connectome mapping"),
        Innovation("neuron_delivery", "~100% neuron delivery (BBB-crossing)",
                   ...
                   _eval_delivery, keywords="AAV blood-brain barrier neuron gene delivery"),
        Innovation("snr_depth", "Signal boost + noise cut at depth (SNR)",
                   ...
                   _eval_snr, keywords="deep tissue brain imaging signal to noise"),
        Innovation("scan_throughput", "Whole-brain scan throughput",
                   ...
                   _eval_throughput, keywords="high-throughput whole-brain imaging microscopy"),
        Innovation("exabyte_assembly", "Exabyte-scale assembly + error-correction",
                   ...
                   keywords="connectome reconstruction segmentation error correction"),
        Innovation("twin_sim_scale", "Whole-brain twin simulation",
                   ...
                   keywords="whole-brain simulation neural network model"),
        Innovation("behavioral_verification", "Behavioural upload-verification",
                   ...
                   _eval_verify, keywords="neural model behavior validation connectome"),
        Innovation("human_safety", "Human safety of the whole chain",
                   ...
                   keywords="focused ultrasound brain safety AAV gene therapy"),
    ]
