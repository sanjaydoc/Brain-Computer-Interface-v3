...
def build_record(topic: str, candidate: dict, prompt: str = "") -> dict:
    ...
    return {
        ...
        "protocol_steps": candidate.get("protocol_steps", []),
        "assumptions": candidate.get("assumptions", []),
        "risks": candidate.get("risks", []),
        "references": candidate.get("references", []),
        "scores": {"novelty": candidate.get("noveltyScore"), "feasibility": candidate.get("feasibilityScore"),
                   "impact": candidate.get("impactScore")},
